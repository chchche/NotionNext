...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个测试工程师, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || ' Chchche', // 您的昵称 例如 tangly1024
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'hmrVcES0zn8KeHxLlF4qN',
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9225798194', // 对应歌单的 id
